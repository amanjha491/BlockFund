...
declare const WALLET_USER_DETAILS_LOCAL_STORAGE_NAME: (clientId: string) => string;
...
declare class Auth<T extends RecoveryShareManagement = RecoveryShareManagement.USER_MANAGED> {
    ...
    loginWithGoogle(args?: T extends RecoveryShareManagement.AWS_MANAGED ? Parameters<AwsManagedLogin["loginWithGoogle"]>[0] : Parameters<UserManagedLogin["loginWithGoogle"]>[0]): Promise<AuthLoginReturnType>;
    /**
     * @description
