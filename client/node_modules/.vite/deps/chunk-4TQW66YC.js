...
var i2 = (s, e2, t) => new Promise((r, n) => {
  ...
  }, d = (l) => l.done ? r(l.value) : Promise.resolve(l.value).then(o, a);
...
var W = (s, e2) => `${Q}-${s}-${e2}`;
var X = (s) => `${Q}-${s}`;
var R = ((t) => (t.USER_MANAGED = "USER_MANAGED", t.AWS_MANAGED = "AWS_MANAGED", t))(R || {});
var Y = ((a) => (a.PAPER_EMAIL_OTP = "PaperEmailOTP", a.GOOGLE = "Google", a.TWITTER = "Twitter", a.COGNITO = "Cognito", a.AUTH0 = "Auth0", a.CUSTOM_JWT = "CustomJWT", a))(Y || {});
var H = ((t) => (t.LOGGED_OUT = "Logged Out", t.LOGGED_IN_WALLET_INITIALIZED = "Logged In, Wallet Initialized", t))(H || {});
var P = ((n) => (n.LOGGED_OUT = "Logged Out", n.LOGGED_IN_WALLET_UNINITIALIZED = "Logged In, Wallet Uninitialized", n.LOGGED_IN_NEW_DEVICE = "Logged In, New Device", n.LOGGED_IN_WALLET_INITIALIZED = "Logged In, Wallet Initialized", n))(P || {});
...
var f = class {
  constructor({ link: e2, iframeId: t, container: r = document.body, iframeStyles: n, onIframeInitialize: o }) {
    this.POLLING_INTERVAL_SECONDS = 1.4;
    this.POST_LOAD_BUFFER_SECONDS = 1;
    let a = document.getElementById(t), d = new URL(e2), l = "1.2.4";
    if (!l)
      throw new Error("Missing SDK_VERSION env var");
    if (d.searchParams.set("sdkVersion", l), !a || a.src != d.href) {
      if (!a) {
        a = document.createElement("iframe");
        let p = u(u({}, ee), n);
        Object.assign(a.style, p), a.setAttribute("id", t), a.setAttribute("fetchpriority", "high"), r.appendChild(a);
      }
      a.src = d.href, a.setAttribute("data-version", l), a.onload = this.onIframeLoadHandler(a, this.POST_LOAD_BUFFER_SECONDS, o);
    }
    this.iframe = a;
  }
  ...
  onIframeLoadHandler(e2, t, r) {
    return () => i2(this, null, function* () {
      yield new Promise((o, a) => i2(this, null, function* () {
        var p;
        let d = new MessageChannel();
        d.port1.onmessage = (m) => {
          let { data: c } = m;
          return d.port1.close(), c.success ? (G.set(e2.src, true), r && r(), o(true)) : a(new Error(c.error));
        }, yield v(t);
        let l = "initIframe";
  ...
  call(o) {
    return i2(this, arguments, function* ({ procedureName: e2, params: t, showIframe: r = false, injectRecoveryCode: n = { isInjectRecoveryCode: false } }) {
...
function re({ clientId: s, path: e2, queryParams: t }) {
  ...
  if (t)
    for (let o of Object.keys(t))
      r.searchParams.set(o, ((n = t[o]) == null ? void 0 : n.toString()) || "");
  return r.searchParams.set("clientId", s), r;
}
var ie = "paper-embedded-wallet-iframe";
var A = class {
  constructor({ querier: e2, preLogin: t, postLogin: r, clientId: n }) {
    this.LoginQuerier = e2, this.preLogin = t, this.postLogin = r, this.clientId = n;
  }
  sendPaperEmailLoginOtp(r) {
    return i2(this, arguments, function* ({ email: e2, recoveryShareManagement: t }) {
      yield this.preLogin();
      let { isNewUser: n, isNewDevice: o, recoveryShareManagement: a } = yield this.LoginQuerier.call({ procedureName: "sendPaperEmailLoginOtp", params: { email: e2, recoveryShareManagement: t } });
      return { isNewUser: n, isNewDevice: o, recoveryShareManagement: a };
    });
  }
};
var C = class extends A {
  constructor() {
    super(...arguments);
    this.closeWindow = ({ isWindowOpenedByFn: t, win: r, closeOpenedWindow: n }) => {
      t ? r == null || r.close() : r && n ? n(r) : r && r.close();
    };
  }
  loginWithPaperModal() {
    return i2(this, null, function* () {
  ...
  loginWithGoogle(t) {
    return i2(this, null, function* () {
      yield this.preLogin();
      let r = t == null ? void 0 : t.openedWindow, n = false;
      if (r || (r = window.open("", "Login", "width=350, height=500"), n = true), !r)
        throw new Error("Something went wrong opening pop-up");
      yield this.preLogin();
      let { loginLink: o } = yield this.getGoogleLoginUrl();
      r.location.href = o;
      let a = yield new Promise((d, l) => {
          ...
          if (c.origin === i()) {
            ...
            switch (c.data.eventType) {
              case "userLoginSuccess": {
                window.removeEventListener("message", m), clearInterval(p), this.closeWindow({ isWindowOpenedByFn: n, win: r, closeOpenedWindow: t == null ? void 0 : t.closeOpenedWindow }), c.data.authResult && d(c.data.authResult);
                break;
              }
              case "userLoginFailed": {
                window.removeEventListener("message", m), clearInterval(p), this.closeWindow({ isWindowOpenedByFn: n, win: r, closeOpenedWindow: t == null ? void 0 : t.closeOpenedWindow }), l(new Error(c.data.error));
                break;
              }
      ...
      return this.postLogin({ storedToken: y(u({}, a.storedToken), { shouldStoreCookieString: true }), walletDetails: y(u({}, a.walletDetails), { isIframeStorageEnabled: false }) });
    });
  }
  loginWithPaperEmailOtp(r) {
    return i2(this, arguments, function* ({ email: t }) {
      yield this.preLogin();
      let n = yield this.LoginQuerier.call({ procedureName: "loginWithPaperModal", params: { email: t, recoveryShareManagement: "AWS_MANAGED" }, showIframe: true, injectRecoveryCode: { isInjectRecoveryCode: true } });
      return this.postLogin(n);
    });
  }
  verifyPaperEmailLoginOtp(n) {
...
var D = class extends A {
  ...
  loginWithPaperEmailOtp(r) {
    return i2(this, arguments, function* ({ email: e2, recoveryCode: t }) {
      yield this.preLogin();
      let n = yield this.LoginQuerier.call({ procedureName: "loginWithPaperModal", params: { email: e2, recoveryCode: t }, showIframe: true, injectRecoveryCode: { isInjectRecoveryCode: true } });
      return this.postLogin(n);
    });
  }
  verifyPaperEmailLoginOtp(n) {
...
var M = class {
  constructor({ clientId: e2, advancedOptions: t, querier: r, onAuthSuccess: n }) {
    var o;
    this.clientId = e2, this.advancedOptions = { recoveryShareManagement: (o = t == null ? void 0 : t.recoveryShareManagement) != null ? o : "AWS_MANAGED" }, this.AuthQuerier = r, this.localStorage = new h({ clientId: e2 }), this.onAuthSuccess = n, this.userManagedLogin = new D({ postLogin: (a) => i2(this, null, function* () {
      return this.postLogin(a);
    }), preLogin: () => i2(this, null, function* () {
      yield this.preLogin();
    }), querier: r, clientId: e2 }), this.awsManagedLogin = new C({ postLogin: (a) => i2(this, null, function* () {
      return this.postLogin(a);
    }), preLogin: () => i2(this, null, function* () {
      yield this.preLogin();
...
var T = class extends Signer {
  constructor({ provider: t, clientId: r, querier: n }) {
    var o;
    super();
    this.DEFAULT_ETHEREUM_CHAIN_ID = 5;
    this.clientId = r, this.querier = n, this.endpoint = (o = t.connection) == null ? void 0 : o.url, defineReadOnly(this, "provider", t);
  }
  getAddress() {
    return i2(this, null, function* () {
  ...
  signMessage(t) {
    return i2(this, null, function* () {
      ...
      let { signedMessage: n } = yield this.querier.call({ procedureName: "signMessage", params: { message: t, chainId: (l = (d = yield (a = this.provider) == null ? void 0 : a.getNetwork()) == null ? void 0 : d.chainId) != null ? l : this.DEFAULT_ETHEREUM_CHAIN_ID, rpcEndpoint: this.endpoint } });
      return n;
    });
  }
  signTransaction(t) {
    return i2(this, null, function* () {
      var n, o, a;
      let { signedTransaction: r } = yield this.querier.call({ procedureName: "signTransaction", params: { transaction: t, chainId: (a = (o = yield (n = this.provider) == null ? void 0 : n.getNetwork()) == null ? void 0 : o.chainId) != null ? a : this.DEFAULT_ETHEREUM_CHAIN_ID, rpcEndpoint: this.endpoint } });
      return r;
    });
  }
  _signTypedData(t, r, n) {
    return i2(this, null, function* () {
      var a, d, l;
      let { signedTypedData: o } = yield this.querier.call({ procedureName: "signTypedDataV4", params: { domain: t, types: r, message: n, chainId: (l = (d = yield (a = this.provider) == null ? void 0 : a.getNetwork()) == null ? void 0 : d.chainId) != null ? l : this.DEFAULT_ETHEREUM_CHAIN_ID, rpcEndpoint: this.endpoint } });
      return o;
    });
  }
  connect(t) {
...
var O = class {
  constructor({ clientId: e2, chain: t, querier: r }) {
    this.clientId = e2, this.chain = t, this.walletManagerQuerier = r, this.gasless = new w({ chain: t, clientId: e2, querier: r }), this.localStorage = new h({ clientId: e2 });
  }
  postWalletSetUp(o) {
    return i2(this, arguments, function* ({ deviceShareStored: e2, walletAddress: t, isIframeStorageEnabled: r, walletUserId: n }) {
      return r || (yield this.localStorage.saveDeviceShare(e2, n)), { walletAddress: t };
    });
  }
  getUserWalletStatus() {
    return i2(this, null, function* () {
  ...
  setChain(t) {
    return i2(this, arguments, function* ({ chain: e2 }) {
      this.chain = e2, this.gasless = new w({ chain: e2, clientId: this.clientId, querier: this.walletManagerQuerier });
    });
  }
...
var N = class {
  constructor({ clientId: e2, chain: t, styles: r, advancedOptions: n }) {
    this.clientId = e2, this.querier = new _({ clientId: e2, customizationOptions: r }), this.wallet = new O({ clientId: e2, chain: t, querier: this.querier }), this.auth = new M({ clientId: e2, advancedOptions: u({ recoveryShareManagement: "USER_MANAGED" }, n != null ? n : {}), querier: this.querier, onAuthSuccess: (o) => i2(this, null, function* () {
      return yield this.wallet.postWalletSetUp(y(u({}, o.walletDetails), { walletUserId: o.storedToken.authDetails.userWalletId })), yield this.querier.call({ procedureName: "initIframe", params: { deviceShareStored: o.walletDetails.deviceShareStored, clientId: this.clientId, walletUserId: o.storedToken.authDetails.userWalletId, authCookie: o.storedToken.cookieString } }), { user: { status: "Logged In, Wallet Initialized", authDetails: o.storedToken.authDetails, wallet: this.wallet, walletAddress: o.walletDetails.walletAddress } };
    }) });
  }
  getUser() {
    return i2(this, null, function* () {
...
//# sourceMappingURL=chunk-4TQW66YC.js.map
