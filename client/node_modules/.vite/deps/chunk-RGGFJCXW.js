    ...
    function hashBlocks(w3, v, p3, pos, len) {
      while (len >= 64) {
        ...
        for (var i2 = 0; i2 < 16; i2++) {
          var j3 = pos + i2 * 4;
          w3[i2] = binary_1.readUint32BE(p3, j3);
        }
    ...
    if (g4[n2])
      i2[n2] = function(v) {
        return new Promise(function(a2, b3) {
          q2.push([n2, v, a2, b3]) > 1 || resume(n2, v);
        });
      };
  }
...
function __asyncDelegator2(o) {
  ...
  function verb(n2, f2) {
    i2[n2] = o[n2] ? function(v) {
      return (p3 = !p3) ? { value: __await2(o[n2](v)), done: n2 === "return" } : f2 ? f2(v) : v;
    } : f2;
  }
}
...
function __createBinding3(o, m2, k2, k22) {
  if (k22 === void 0)
    k22 = k2;
  o[k22] = m2[k2];
}
...
function __asyncDelegator3(o) {
  ...
  function verb(n2, f2) {
    i2[n2] = o[n2] ? function(v) {
      return (p3 = !p3) ? { value: __await3(o[n2](v)), done: n2 === "return" } : f2 ? f2(v) : v;
    } : f2;
  }
}
...
var init_tslib_es63 = __esm({
  "node_modules/@walletconnect/environment/node_modules/tslib/tslib.es6.js"() {
    extendStatics3 = function(d2, b3) {
      extendStatics3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d3, b4) {
        d3.__proto__ = b4;
      } || function(d3, b4) {
        for (var p3 in b4)
          if (b4.hasOwnProperty(p3))
...
function __extends4(d2, b3) {
  extendStatics4(d2, b3);
  function __() {
    this.constructor = d2;
  }
  d2.prototype = b3 === null ? Object.create(b3) : (__.prototype = b3.prototype, new __());
...
function __createBinding4(o, m2, k2, k22) {
  if (k22 === void 0)
    k22 = k2;
  o[k22] = m2[k2];
}
...
function __asyncGenerator4(thisArg, _arguments, generator) {
  ...
  function step(r) {
    r.value instanceof __await4 ? Promise.resolve(r.value.v).then(fulfill, reject) : settle(q2[0][2], r);
  }
  function fulfill(value) {
    resume("next", value);
  }
...
function __asyncDelegator4(o) {
  ...
  function verb(n2, f2) {
    i2[n2] = o[n2] ? function(v) {
      return (p3 = !p3) ? { value: __await4(o[n2](v)), done: n2 === "return" } : f2 ? f2(v) : v;
    } : f2;
  }
}
...
var init_tslib_es64 = __esm({
  "node_modules/@walletconnect/keyvaluestorage/node_modules/tslib/tslib.es6.js"() {
    extendStatics4 = function(d2, b3) {
      extendStatics4 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d3, b4) {
        d3.__proto__ = b4;
      } || function(d3, b4) {
        for (var p3 in b4)
          if (b4.hasOwnProperty(p3))
...
var require_utils3 = __commonJS({
  "node_modules/@walletconnect/keyvaluestorage/dist/cjs/shared/utils.js"(exports) {
    ...
    var safe_json_utils_1 = require_cjs6();
...
function __extends5(d2, b3) {
  extendStatics5(d2, b3);
  function __() {
    this.constructor = d2;
  }
  d2.prototype = b3 === null ? Object.create(b3) : (__.prototype = b3.prototype, new __());
...
function __createBinding5(o, m2, k2, k22) {
  if (k22 === void 0)
    k22 = k2;
  o[k22] = m2[k2];
}
...
function __asyncGenerator5(thisArg, _arguments, generator) {
  ...
  function step(r) {
    r.value instanceof __await5 ? Promise.resolve(r.value.v).then(fulfill, reject) : settle(q2[0][2], r);
  }
  function fulfill(value) {
    resume("next", value);
  }
...
function __asyncDelegator5(o) {
  ...
  function verb(n2, f2) {
    i2[n2] = o[n2] ? function(v) {
      return (p3 = !p3) ? { value: __await5(o[n2](v)), done: n2 === "return" } : f2 ? f2(v) : v;
    } : f2;
  }
}
function __asyncValues5(o) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var m2 = o[Symbol.asyncIterator], i2;
  return m2 ? m2.call(o) : (o = typeof __values5 === "function" ? __values5(o) : o[Symbol.iterator](), i2 = {}, verb("next"), verb("throw"), verb("return"), i2[Symbol.asyncIterator] = function() {
    return this;
  }, i2);
  function verb(n2) {
    i2[n2] = o[n2] && function(v) {
...
var init_tslib_es65 = __esm({
  "node_modules/@walletconnect/heartbeat/node_modules/tslib/tslib.es6.js"() {
    extendStatics5 = function(d2, b3) {
      extendStatics5 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d3, b4) {
        d3.__proto__ = b4;
      } || function(d3, b4) {
        for (var p3 in b4)
          if (b4.hasOwnProperty(p3))
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p3, q2) {
      const a2 = gf(), b3 = gf(), c2 = gf(), d2 = gf(), e = gf(), f2 = gf(), g4 = gf(), h3 = gf(), t = gf();
      sub(a2, p3[1], p3[0]);
      sub(t, q2[1], q2[0]);
      mul(a2, a2, t);
      add(b3, p3[0], p3[1]);
...
function Kn(e) {
  ...
  const t = typeof e.senderPublicKey < "u" ? fromString(e.senderPublicKey, p) : void 0, r = typeof e.iv < "u" ? fromString(e.iv, p) : (0, import_random.randomBytes)(Z), o = new import_chacha20poly1305.ChaCha20Poly1305(fromString(e.symKey, p)).seal(r, fromString(e.message, x));
...
function xn(e, n2) {
  const t = ee(e);
  return Re({ type: $(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString(t.senderPublicKey, p) : void 0, receiverPublicKey: n2 == null ? void 0 : n2.receiverPublicKey });
}
function Re(e) {
...
function Ki(r, e) {
  ...
  var o = r.length, h3 = r.charAt(0), u2 = Math.log(o) / Math.log(256), d2 = Math.log(256) / Math.log(o);
  function p3(c2) {
    ...
    for (var T = (_2 - v) * d2 + 1 >>> 0, m2 = new Uint8Array(T); v !== _2; ) {
      for (var S3 = c2[v], A3 = 0, I2 = T - 1; (S3 !== 0 || A3 < z) && I2 !== -1; I2--, A3++)
        S3 += 256 * m2[I2] >>> 0, m2[I2] = S3 % o >>> 0, S3 = S3 / o >>> 0;
      if (S3 !== 0)
    ...
    for (var O3 = T - z; O3 !== T && m2[O3] === 0; )
      O3++;
    for (var q2 = h3.repeat(b3); O3 < T; ++O3)
      q2 += r.charAt(m2[O3]);
    return q2;
  }
  function y3(c2) {
    ...
    if (c2[b3] !== " ") {
      for (var z = 0, v = 0; c2[b3] === h3; )
        z++, b3++;
      for (var _2 = (c2.length - b3) * u2 + 1 >>> 0, T = new Uint8Array(_2); c2[b3]; ) {
        var m2 = t[c2.charCodeAt(b3)];
        if (m2 === 255)
          return;
        for (var S3 = 0, A3 = _2 - 1; (m2 !== 0 || S3 < v) && A3 !== -1; A3--, S3++)
          m2 += o * T[A3] >>> 0, T[A3] = m2 % 256 >>> 0, m2 = m2 / 256 >>> 0;
        if (m2 !== 0)
          throw new Error("Non-zero carry");
        v = S3, b3++;
      }
      if (c2[b3] !== " ") {
        for (var I2 = _2 - v; I2 !== _2 && T[I2] === 0; )
          I2++;
        for (var O3 = new Uint8Array(z + (_2 - I2)), q2 = z; I2 !== _2; )
          O3[q2++] = T[I2++];
        return O3;
      }
    }
...
var W2 = ({ name: r, prefix: e, encode: t, decode: i2 }) => new Ji(r, e, t, i2);
var K = ({ prefix: r, name: e, alphabet: t }) => {
  const { encode: i2, decode: s } = Vi(t, e);
  return W2({ prefix: r, name: e, encode: i2, decode: (n2) => ze(s(n2)) });
};
var Wi = (r, e, t, i2) => {
  const s = {};
  ...
  for (let d2 = 0; d2 < n2; ++d2) {
    ...
    h3 = h3 << t | p3, o += t, o >= 8 && (o -= 8, a2[u2++] = 255 & h3 >> o);
  }
  if (o >= t || 255 & h3 << 8 - o)
...
var g2 = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i2 }) => W2({ prefix: e, name: r, encode(s) {
  return Xi(s, i2, t);
}, decode(s) {
  return Wi(s, i2, t, r);
} });
var Qi = W2({ prefix: "\0", name: "identity", encode: (r) => ji(r), decode: (r) => qi(r) });
...
var xs = Ue2.reduce((r, e, t) => (r[e.codePointAt(0)] = t, r), []);
function As(r) {
...
var he2 = (r, e) => {
  ...
  return ke2(r, n2, 0), ke2(t, n2, i2), n2.set(e, s), new Zs(r, t, e, n2);
};
var Zs = class {
  constructor(e, t, i2, s) {
...
var Be2 = ({ name: r, code: e, encode: t }) => new er2(r, e, t);
var er2 = class {
  constructor(e, t, i2) {
  ...
  digest(e) {
    if (e instanceof Uint8Array) {
      ...
      return t instanceof Uint8Array ? he2(this.code, t) : t.then((i2) => he2(this.code, i2));
    } else
      throw Error("Unknown type, must be binary type");
  }
};
...
var Je2 = He2("utf8", "u", (r) => "u" + new TextDecoder("utf8").decode(r), (r) => new TextEncoder().encode(r.substring(1)));
var ce2 = He2("ascii", "a", (r) => {
  let e = "a";
...
var bt2 = "0.3";
var mt2 = import_time3.FIVE_SECONDS * 1e3;
var ft2 = "pairing";
var Et2 = "0.3";
...
var Rt = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.keychain = /* @__PURE__ */ new Map(), this.name = tt, this.version = it2, this.initialized = false, this.storagePrefix = x2, this.init = async () => {
      if (!this.initialized) {
...
var _t2 = class {
  constructor(e, t, i2) {
    this.core = e, this.logger = t, this.name = Ze2, this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const n2 = await this.getClientSeed(), a2 = generateKeyPair2(n2), o = Dn(), h3 = et2;
      ...
      const u2 = this.getSymKey(s), { type: d2, senderPublicKey: p3 } = o;
      return Kn({ type: d2, symKey: u2, message: h3, senderPublicKey: p3 });
    }, this.decode = async (s, n2, a2) => {
      this.isInitialized();
      const o = xn(n2, a2);
      if (Fn(o)) {
        const h3 = o.receiverPublicKey, u2 = o.senderPublicKey;
        s = await this.generateSharedKey(h3, u2);
      }
      try {
        const h3 = this.getSymKey(s), u2 = Ln({ symKey: h3, encoded: n2 });
        return safeJsonParse(u2);
      } catch (h3) {
...
var Tt = class extends a {
  constructor(e, t) {
    super(e, t), this.logger = e, this.core = t, this.messages = /* @__PURE__ */ new Map(), this.name = st2, this.version = rt, this.initialized = false, this.storagePrefix = x2, this.init = async () => {
      if (!this.initialized) {
...
var Dr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = at2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time3.toMiliseconds)(import_time3.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i2, s, n2) => {
      ...
      try {
        const o = (n2 == null ? void 0 : n2.ttl) || nt2, h3 = mt(n2), u2 = (n2 == null ? void 0 : n2.prompt) || false, d2 = (n2 == null ? void 0 : n2.tag) || 0, p3 = (n2 == null ? void 0 : n2.id) || getBigIntRpcId().toString(), y3 = { topic: i2, message: s, opts: { ttl: o, relay: h3, prompt: u2, tag: d2, id: p3 } }, $2 = setTimeout(() => this.queue.set(p3, y3), this.publishTimeout);
        try {
          await await it(this.rpcPublish(i2, s, o, h3, u2, d2, p3), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(p3), this.relayer.events.emit(D2.publish, y3);
        } catch (c2) {
  ...
  rpcPublish(e, t, i2, s, n2, a2, o) {
    ...
    return w((h3 = y3.params) == null ? void 0 : h3.prompt) && ((u2 = y3.params) == null || delete u2.prompt), w((d2 = y3.params) == null ? void 0 : d2.tag) && ((p3 = y3.params) == null || delete p3.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: y3 }), this.relayer.request(y3);
  }
...
var Ot = class extends d {
  ...
  onSubscribe(e, t) {
    this.setSubscription(e, De2(V2({}, t), { id: e })), this.pending.delete(t.topic);
  }
  onBatchSubscribe(e) {
    e.length && e.forEach((t) => {
      this.setSubscription(t.id, V2({}, t)), this.pending.delete(t.topic);
    });
  }
  ...
  addSubscription(e, t) {
    this.subscriptions.set(e, V2({}, t)), this.topicMap.set(t.topic, e), this.events.emit(C.created, t);
  }
  getSubscription(e) {
  ...
  deleteSubscription(e, t) {
    ...
    this.subscriptions.delete(e), this.topicMap.delete(i2.topic, e), this.events.emit(C.deleted, De2(V2({}, i2), { reason: t }));
  }
  async persist() {
  ...
  async batchSubscribe(e) {
    ...
    j(t) && this.onBatchSubscribe(t.map((i2, s) => De2(V2({}, e[s]), { id: i2 })));
  }
  async onConnect() {
...
var zt2 = class extends g {
  constructor(e) {
    ...
    }, this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? (0, import_logger.generateChildLogger)(e.logger, this.name) : (0, import_logger.pino)((0, import_logger.getDefaultLoggerOptions)({ level: e.logger || ht2 })), this.messages = new Tt(this.logger, e.core), this.subscriber = new Ot(this, this.logger), this.publisher = new Dr(this, this.logger), this.relayUrl = (e == null ? void 0 : e.relayUrl) || de2, this.projectId = e.projectId, this.provider = {};
  }
  async init() {
...
var Ft2 = class extends p2 {
  constructor(e, t, i2, s = x2, n2 = void 0) {
    super(e, t, i2, s), this.core = e, this.logger = t, this.name = i2, this.map = /* @__PURE__ */ new Map(), this.version = pt2, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
...
var $t2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = ft2, this.version = Et2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = x2, this.ignoredPayloadTypes = [_], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i2 = Dn(), s = await this.core.crypto.setSymKey(i2), n2 = lt(import_time3.FIVE_MINUTES), a2 = { protocol: ot }, o = { topic: s, expiry: n2, relay: a2, active: false }, h3 = Nt({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i2, relay: a2 });
      ...
      const h3 = lt(import_time3.FIVE_MINUTES), u2 = { topic: s, relay: a2, expiry: h3, active: false };
      return await this.pairings.set(s, u2), this.core.expirer.set(s, h3), i2.activatePairing && await this.activate({ topic: s }), this.events.emit(B2.create, u2), u2;
      ...
      if (this.pairings.keys.includes(s)) {
        ...
        this.events.once(ft("pairing_ping", n2), ({ error: u2 }) => {
          u2 ? h3(u2) : o();
        }), await a2();
      }
      ...
      const a2 = formatJsonRpcResult(i2, n2), o = await this.core.crypto.encode(s, a2), h3 = await this.core.history.get(s, i2), u2 = F[h3.request.method].res;
      await this.core.relayer.publish(s, o, u2), await this.core.history.resolve(a2);
    }, this.sendError = async (i2, s, n2) => {
      const a2 = formatJsonRpcError(i2, n2), o = await this.core.crypto.encode(s, a2), h3 = await this.core.history.get(s, i2), u2 = F[h3.request.method] ? F[h3.request.method].res : F.unregistered_method.res;
      await this.core.relayer.publish(s, o, u2), await this.core.history.resolve(a2);
...
var Mt2 = class extends h2 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = wt, this.version = vt2, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
...
var kt2 = class extends E {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = It, this.version = Ct2, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
...
var Kt2 = class extends y {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = Q2, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (i2) => {
      if (this.verifyDisabled || H() || !q())
        return;
      const s = (i2 == null ? void 0 : i2.verifyUrl) || Z2;
      ...
      await Promise.race([new Promise((n2) => {
        ...
        a2.id = Q2, a2.src = `${this.verifyUrl}/${this.projectId}`, a2.style.display = "none", document.body.append(a2), this.iframe = a2, i2 = n2;
    ...
    }, this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.verifyUrl = Z2, this.abortController = new AbortController(), this.isDevEnv = te() && process.env.IS_VITEST;
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var ee2 = class _ee extends n {
  constructor(e) {
    super(e), this.protocol = ue2, this.version = We2, this.name = X2, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i2, s) => this.events.on(i2, s), this.once = (i2, s) => this.events.once(i2, s), this.off = (i2, s) => this.events.off(i2, s), this.removeListener = (i2, s) => this.events.removeListener(i2, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || de2;
    ...
    this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.heartbeat = new import_heartbeat.HeartBeat(), this.crypto = new _t2(this, this.logger, e == null ? void 0 : e.keychain), this.history = new Mt2(this, this.logger), this.expirer = new kt2(this, this.logger), this.storage = e != null && e.storage ? e.storage : new import_keyvaluestorage.default(qt2(qt2({}, Qe2), e == null ? void 0 : e.storageOptions)), this.relayer = new zt2({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new $t2(this, this.logger), this.verify = new Kt2(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new _ee(e);
    await t.initialize();
...
var de3 = (m2, r, e) => r in m2 ? ns2(m2, r, { enumerable: true, configurable: true, writable: true, value: e }) : m2[r] = e;
var g3 = (m2, r) => {
  for (var e in r || (r = {}))
...
var ps2 = class extends S2 {
  constructor(r) {
    super(r), this.name = ce3, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: I.idle, queue: [] }, this.sessionRequestQueue = { state: I.idle, queue: [] }, this.requestQueueDelay = import_time4.ONE_SECOND, this.init = async () => {
      ...
      const h3 = await this.client.core.crypto.generateKeyPair(), R3 = g3({ requiredNamespaces: i2, optionalNamespaces: n2, relays: a2 ?? [{ protocol: ot }], proposer: { publicKey: h3, metadata: this.client.metadata } }, o && { sessionProperties: o }), { reject: w3, resolve: T, done: K2 } = st(import_time4.FIVE_MINUTES, oe3);
      if (this.events.once(ft("session_connect"), async ({ error: v, session: S3 }) => {
        if (v)
          w3(v);
        else if (S3) {
          S3.self.publicKey = h3;
          const B3 = b2(g3({}, S3), { requiredNamespaces: S3.requiredNamespaces, optionalNamespaces: S3.optionalNamespaces });
          await this.client.session.set(S3.topic, B3), await this.setExpiry(S3.topic, S3.expiry), c2 && await this.client.core.pairing.updateMetadata({ topic: c2, metadata: S3.peer.metadata }), T(B3);
        }
      }), !c2) {
        const { message: v } = N("NO_MATCHING_KEY", `connect() pairing topic: ${c2}`);
        throw new Error(v);
      }
      const L3 = await this.sendRequest({ topic: c2, method: "wc_sessionPropose", params: R3 }), ue3 = lt(import_time4.FIVE_MINUTES);
      return await this.setProposal(L3, g3({ id: L3, expiry: ue3 }, R3)), { uri: p3, approval: K2 };
      ...
      const h3 = await this.client.core.crypto.generateKeyPair(), R3 = c2.publicKey, w3 = await this.client.core.crypto.generateSharedKey(h3, R3);
      ...
      const T = g3({ relay: { protocol: t ?? "irn" }, namespaces: i2, requiredNamespaces: p3, optionalNamespaces: d2, pairingTopic: a2, controller: { publicKey: h3, metadata: this.client.metadata }, expiry: lt(A2) }, n2 && { sessionProperties: n2 });
      ...
      return await this.client.session.set(w3, K2), await this.setExpiry(w3, lt(A2)), { topic: w3, acknowledged: () => new Promise((L3) => setTimeout(() => L3(this.client.session.get(w3)), 500)) };
    }, this.reject = async (e) => {
      ...
      return this.events.once(ft("session_extend", t), ({ error: a2 }) => {
        a2 ? o(a2) : n2();
      }), await this.setExpiry(s, lt(A2)), { acknowledged: i2 };
    }, this.request = async (e) => {
      await this.isInitialized(), await this.isValidRequest(e);
      const { chainId: s, request: t, topic: i2, expiry: n2 } = e, o = payloadId(), { done: a2, resolve: c2, reject: p3 } = st(n2);
      return this.events.once(ft("session_request", o), ({ error: d2, result: h3 }) => {
        ...
        const h3 = await this.client.core.storage.getItem(W3);
      ...
      const { topic: s, method: t, params: i2, expiry: n2, relayRpcId: o, clientRpcId: a2, throwOnFailedPublish: c2 } = e, p3 = formatJsonRpcRequest(t, i2, a2);
      if (q() && pe2.includes(t)) {
        const R3 = Mn(JSON.stringify(p3));
        this.client.core.verify.register({ attestationId: R3 });
      }
      const d2 = await this.client.core.crypto.encode(s, p3), h3 = V3[t].req;
      return n2 && (h3.ttl = n2), o && (h3.id = o), this.client.core.history.set(s, p3), c2 ? (h3.internal = b2(g3({}, h3.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, d2, h3)) : this.client.core.relayer.publish(s, d2, h3).catch((R3) => this.client.logger.error(R3)), p3.id;
    }, this.sendResult = async (e) => {
      const { id: s, topic: t, result: i2, throwOnFailedPublish: n2 } = e, o = formatJsonRpcResult(s, i2), a2 = await this.client.core.crypto.encode(t, o), c2 = await this.client.core.history.get(t, s), p3 = V3[c2.request.method].res;
      ...
      const i2 = formatJsonRpcError(e, t), n2 = await this.client.core.crypto.encode(s, i2), o = await this.client.core.history.get(s, e), a2 = V3[o.request.method].res;
      ...
      const { id: t } = s;
      try {
        this.isValidExtend({ topic: e }), await this.setExpiry(e, lt(A2)), await this.sendResult({ id: t, topic: e, result: true }), this.client.events.emit("session_extend", { id: t, topic: e });
      } catch (i2) {
      ...
      const t = { verified: { verifyUrl: s.verifyUrl || Z2, validation: "UNKNOWN", origin: s.url || "" } };
      try {
...
var ds2 = class extends Ft2 {
  constructor(r, e) {
    super(r, e, ae2, G2), this.core = r, this.logger = e;
  }
};
...
var Q3 = class _Q extends b {
  constructor(r) {
    super(r), this.protocol = X3, this.version = F2, this.name = M2.name, this.events = new import_events6.EventEmitter(), this.on = (s, t) => this.events.on(s, t), this.once = (s, t) => this.events.once(s, t), this.off = (s, t) => this.events.off(s, t), this.removeListener = (s, t) => this.events.removeListener(s, t), this.removeAllListeners = (s) => this.events.removeAllListeners(s), this.connect = async (s) => {
      try {
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-RGGFJCXW.js.map
