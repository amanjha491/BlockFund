    ...
    if (!this.paper) {
      this.paper = new Promise(async (resolve, reject) => {
        ...
        try {
          ...
          } = await import("./dist-D6SOH3YM.js");
          const methodToEnum = {
            AWS_MANAGED: R.AWS_MANAGED,
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-paper.browser.esm-UDNRGJIP.js.map
