...
var CoinbaseWalletConnector = class extends WagmiConnector {
  ...
  async getProvider() {
    var _a;
    if (!_classPrivateFieldGet(this, _provider)) {
      let CoinbaseWalletSDK = (await import("./dist-GARR6AMB.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-QI4OP6JV.js.map
