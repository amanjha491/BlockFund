import {
  ...
  require_js,
  require_sha
} from "./chunk-DNLS2M46.js";
import {
  require_browser
} from "./chunk-24KLKIQ6.js";
import "./chunk-K7UQ47UL.js";
import {
  clsx_m_exports,
  init_clsx_m
} from "./chunk-362EO4BZ.js";
import {
  require_events
...
function M(l3, u3, t3, i3, o3, r3, f3, e3, s3) {
  ...
  if (null === k3)
    ...
    if (r3 = r3 && n.call(l3.childNodes), h3 = (d3 = t3.props || c).dangerouslySetInnerHTML, y3 = _3.dangerouslySetInnerHTML, !e3) {
      if (null != r3)
    ...
    QRCodeModel.createBytes = function(buffer2, rsBlocks) {
      ...
      for (var r3 = 0; r3 < rsBlocks.length; r3++) {
        ...
        for (var i4 = 0; i4 < dcdata[r3].length; i4++) {
          dcdata[r3][i4] = 255 & buffer2.buffer[i4 + offset];
        }
        offset += dcCount;
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=dist-GARR6AMB.js.map
