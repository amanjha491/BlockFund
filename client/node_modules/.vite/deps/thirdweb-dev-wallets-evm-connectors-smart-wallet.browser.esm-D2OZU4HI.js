...
var require_ERC4337Utils = __commonJS({
  "node_modules/@account-abstraction/utils/dist/src/ERC4337Utils.js"(exports) {
    ...
    var FailedOpSig = (0, utils_1.keccak256)(Buffer.from("FailedOp(uint256,string)")).slice(0, 10);
  ...
  async createUnsignedUserOp(info, batched) {
    ...
    if (this.paymasterAPI) {
      ...
      const pmOp = {
        ...
        signature: ethers_exports.utils.hexlify(Buffer.alloc(SIG_SIZE, 1))
      };
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-D2OZU4HI.js.map
